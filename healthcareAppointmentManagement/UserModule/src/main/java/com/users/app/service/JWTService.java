...
public class JWTService {
	...
	public String getToken(long userId, Role role, String email) {
 
	    Map<String, Object> claims = new HashMap<>(); // Changed type to Object for long support
 
	    claims.put("userId", userId); // No need for conversion
